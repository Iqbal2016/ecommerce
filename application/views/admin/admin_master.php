...
<html>
  <head>
    ...
    <link href="<?php echo base_url(); ?>admin/dataTables.bootstrap.css" rel="stylesheet">
    <script src="<?php echo base_url(); ?>admin/country.js"  type="text/javascript"></script>    
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>super_admin/" class="logo">
          ...
          <span class="logo-mini"><b>IFERI</b>WALA</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Iferi</b>wala</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo $this->session->userdata('admin_images'); ?>" class="user-image" alt="User Image">
                  <span class="hidden-xs"><?php echo $this->session->userdata('admin_name'); ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="<?php echo $this->session->userdata('admin_images'); ?>" class="img-circle" alt="User Image">
                    <p>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url(); ?>super_admin/category_form/"><i class="fa fa-circle-o"></i> Add Category</a></li>
                <li><a href="<?php echo base_url(); ?>super_admin/all_category"><i class="fa fa-circle-o"></i> View Category</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url(); ?>super_admin/add_product"><i class="fa fa-circle-o"></i> Add product</a></li>
                <li><a href="<?php echo base_url(); ?>super_admin/view_product"><i class="fa fa-circle-o"></i> View product</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url(); ?>super_admin/view_order"><i class="fa fa-circle-o"></i> View Orders</a></li>
              </ul>
            </li>
              <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url(); ?>super_admin/view_piechart"><i class="fa fa-circle-o"></i>Pie Chart</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url(); ?>super_admin/stk_manager"><i class="fa fa-circle-o"></i>Stk Manager</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url(); ?>super_admin/add_admin"><i class="fa fa-circle-o"></i>Add Admin</a></li>
                <li><a href="<?php echo base_url();?>super_admin/all_admin"><i class="fa fa-circle-o"></i> View Admin</a></li>
              </ul>
            </li>
