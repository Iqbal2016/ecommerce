                    ...
                    <?php
                     ...
                     <li class="col-md-3 col-sm-6">
                      <div class="kode-pro-inner">
                          ...
                          <figcaption>
                            <h4><a href="<?php echo base_url(); ?>welcome/product_details/<?php echo $v_product->product_id; ?>"><?php echo $v_product->product_name; ?></a></h4>
                            <p class="kode-pro-cat"><a href="#">Category: <?php echo $v_product->category_name; ?></a></p>
                          </figcaption>
                        </figure>
